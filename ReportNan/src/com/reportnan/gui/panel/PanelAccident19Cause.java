 ...
 *
 * Created on 7 มิถุนายน 2549, 9:48 น.
 */
        ...
        GUIResp,AllPanelResp,CardNameControl,Runnable
{
    ...
    public PanelAccident19Cause(ManageControlSubject mcs)
    {
        theMCS = mcs;
    ...
    private void initComponents()
    {
        ...
        jTableAccident19Cause = new javax.swing.JTable();

        setLayout(new java.awt.GridBagLayout());

        jPanel1.setLayout(new java.awt.GridBagLayout());

        jTableAccident19Cause.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][]
            {
        ...
        jTableAccident19Cause.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        fixedColumnScrollPane1.setViewportView(jTableAccident19Cause);
    ...
    public Vector getAccident19Cause()
    {
        return this.vcData;
    }
    private void showDataInTable(String[] columnname,Vector vc)
    {
        ...
        this.jTableAccident19Cause.setModel(theTableModelGUI);
        if(col!= null && col.length!= 0)
        {
            fixedColumnScrollPane1.setFixedColumnScrollPane(jTableAccident19Cause, 1, 210);
            setTableListReportPattern(col);
        }
        else
        {
            fixedColumnScrollPane1.setFixedColumnScrollPane(jTableAccident19Cause, 0, 210);
    ...
    private void setTableListReportPattern(String [] col)
    {
        ...
        {
                jTableAccident19Cause.getColumnModel().getColumn(i).setCellRenderer(rendererRight);
                jTableAccident19Cause.getColumnModel().getColumn(i).setPreferredWidth(110);
        }
    }
    /**
    ...
    public void run()
    {
        queryAccident19Cause();
    }
    
    private void queryAccident19Cause()
    {
        if(this.theMCS.theManageControl.theReportNanControl.setDateForQuery(this.startDate, this.endDate))
        {
            ...
            this.vcData = this.theMCS.theManageControl.theReportNanControl.queryAccident19Cause();
    ...
    private javax.swing.JTable jTableAccident19Cause;
