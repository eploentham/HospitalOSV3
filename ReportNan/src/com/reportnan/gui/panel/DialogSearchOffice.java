/*
 * DialogSearchOffice.java
 *
 * Created on 20 มิถุนายน 2549, 14:59 น.
 */
 ...
 * @author  ojika
 */
public class DialogSearchOffice extends javax.swing.JDialog
{
    
    ManageControlSubjectSetup theMCS;
    TableModelGUI theTableModelGUI;
    Office theOffice,theOfficeTemp;
    Vector vOffice,vData;
    String[] colName;
    
    /**สำหรับตรวจสอบหน้าที่เลือก เพื่อแสดงผลเป็นหน้า ซึ่งเป็นค่าของ Offset ที่จะส่งไป Query โดย 1 หน้าแสดง 15 Record */
    int offsetPage = 0;
    
    public DialogSearchOffice(java.awt.Frame parent, boolean modal,ManageControlSubjectSetup mcs)
    {
        super(parent, modal);
        theMCS = mcs;
        initComponents();
        ...
        this.setTitle(Language.getTextBundle("SearchOffice"));
        searchData();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(127, 70));
        ...
        jPanel3.setMinimumSize(new java.awt.Dimension(92, 25));
        jButtonAdd.setText("+");
        jButtonAdd.setMargin(new java.awt.Insets(0, 0, 0, 0));
        jButtonAdd.setMinimumSize(new java.awt.Dimension(24, 224));
    ...
    {//GEN-HEADEREND:event_jButtonAddActionPerformed
        // เลือกเพิ่มรายการที่เลือก ให้กับ Panel ที่เรียก Dialog
        setSelectInRow(jTableOffice.getSelectedRows());
    ...
    {//GEN-HEADEREND:event_jButtonForwardActionPerformed
        // เพิ่มค่าของ offset ของรายการที่ต้องการค้นหา
    ...
    {//GEN-HEADEREND:event_jButtonBackActionPerformed
        // ลบค่าของ offset ของรายการที่ต้องการค้นหา 
        if(this.offsetPage >= 15)
        {
            this.offsetPage = this.offsetPage - 15;
        }
        searchData();
    ...
    {//GEN-HEADEREND:event_jButtonSearchActionPerformed
        // set ค่า offset เริ่มต้นที่ต้องการค้นหา เมื่อมีการค้นหาใหม่
        this.offsetPage = 0;
        searchData();
    ...
    {//GEN-HEADEREND:event_jTextFieldSearchActionPerformed
        // ค้นหา Office ใช้ Event ของปุ่มค้นหา
        jButtonSearchActionPerformed(evt);
    }//GEN-LAST:event_jTextFieldSearchActionPerformed
    
    /**
     * สำหรับ set ค่าที่เลือกให้กับ temp เพื่อส่งค่าให้กับ panel ต่อไป
     * @Author ojika
     * @Date 21/06/2549
     */
    ...
    {   
        ...
        {   
            ...
            {
                theOfficeTemp = (Office)vOffice.get(rows[i]);
                vData.add(theOfficeTemp);
                theOfficeTemp = null;
            }
    ...
    /**
     *ตรวจสอบว่าจะ notify ข้อมูลไปยัง Panel ใด
     *@Author ojika
     *@Date 21/06/2549
     */
    private void checkNotify()
    {
        // ส่งค่าให้กับ panelOperatingItem ส่งได้เพียงค่าเดียวเท่านั้น
        this.theMCS.theManageSubject.theReferHospitalSubject.notifySaveReferHospital((Office)this.vData.get(0));
    }
    
    /**
     * ค้นหารายการตรวจรักษา ตาม Keyword และ ตาม Offset ที่กำหนด 
     * @Author ojika
     * @Date 21/06/2549
     */
    ...
    {        
        ...
        vOffice = this.theMCS.theManageControl.theDialogControl.selectOfficeByKeyword(keyword,this.offsetPage);  
        showDataToTable(vOffice);
    ...
    private void showDataToTable(Vector vc)
    {
        ...
        if(vc != null)
        {
            ...
            for(int i = 0 ; i < size ;i++)
            {
                theOfficeTemp = (Office)vc.get(i);
                theTableModelGUI.setValueAt(theOfficeTemp.getObjectId(),i, 0);
                theTableModelGUI.setValueAt(theOfficeTemp.name,i, 1);
                theOfficeTemp = null;
            }
        }
        jTableOffice.setModel(theTableModelGUI);
        
        jTableOffice.getColumnModel().getColumn(0).setPreferredWidth(25);
        jTableOffice.getColumnModel().getColumn(1).setPreferredWidth(100);
    }
    ...
    {
        this.colName = new String[] {Language.getTextBundle("Code"),Language.getTextBundle("Name")};
    ...
    public static void main(String args[])
    {
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new DialogSearchOffice(new javax.swing.JFrame(), true,null).setVisible(true);
            }
        });
    }
