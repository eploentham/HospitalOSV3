/*
 * PanelPatientOPDRemain.java
 *
 * Created on 6 มิถุนายน 2549, 18:06 น.
 */
 ...
 * @author  pu
 */
public class PanelPatientOPDRemain extends javax.swing.JPanel implements 
        GUIResp,AllPanelResp,Runnable,CardNameControl
{
    ...
    Vector vcDataQuery;
    /**
     * Creates new form PanelPatientOPDRemain 
     */
    public PanelPatientOPDRemain(ManageControlSubject mcs)
    { 
        theMCS = mcs;
    ...
    private void initComponents()
    {
        ...
        jTableOPDDebtor = new javax.swing.JTable();

        setLayout(new java.awt.GridBagLayout());

        jPanel1.setLayout(new java.awt.GridBagLayout());

        jTableOPDDebtor.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][]
            {
        ...
        jTableOPDDebtor.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_LAST_COLUMN);
        fixedColumnScrollPane1.setViewportView(jTableOPDDebtor);
    ...
    public Vector getPatientOPDRemain()
    {
        return this.vcData;
    }
    private void showDataInTable(String[] columnname,Vector vc)
    {
        ...
        this.jTableOPDDebtor.setModel(theTableModelGUI);
        if(col!= null && col.length!= 0)
        {
            fixedColumnScrollPane1.setFixedColumnScrollPane(jTableOPDDebtor, 1,250);
            setTableListReportPattern(col);
        }
        else
        {
            fixedColumnScrollPane1.setFixedColumnScrollPane(jTableOPDDebtor, 0, 250);
    ...
    private void setTableListReportPattern(String [] col)
    {
        ...
        for(int i=0;i<size-1;i++)
        {
            if(i >=0 && i<3)
            {
                jTableOPDDebtor.getColumnModel().getColumn(i).setPreferredWidth(100);
            }
            else
            {
                jTableOPDDebtor.getColumnModel().getColumn(i).setPreferredWidth(100);
                jTableOPDDebtor.getColumnModel().getColumn(i).setCellRenderer(rendererRight);
            }
        }
    }
    /**
    ...
    private void queryPatientOPDRemain()
    {
        if(this.theMCS.theManageControl.theReportNanControl.setDateForQuery(this.startDate, this.endDate))
        {
            ...
            this.vcData = this.theMCS.theManageControl.theReportNanControl.queryPatientOPDRemain();
    ...
    private javax.swing.JTable jTableOPDDebtor;
