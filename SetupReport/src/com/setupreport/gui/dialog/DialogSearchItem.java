/*
 * DialogSearchItemDrug.java
 *
 * Created on 8 มีนาคม 2549, 16:06 น.
 */
...
public class DialogSearchItem extends javax.swing.JDialog {
    ...
    public DialogSearchItem(java.awt.Frame parent, boolean modal,HosManage hosmanage,int panel) {
        super(parent, modal);
        ...
        this.setTitle(Language.getTextBundle("SearchItem",language));
        setLanguage();
    ...
    {//GEN-HEADEREND:event_jButtonPreActionPerformed
// TODO add your handling code here:
    ...
    {
        //PanelDentalProtectItem
        if(this.flag_notify == 0)
        {
            theHosManage.theHosControl.theHosSubject.theDentalProtectItemSubject.notifySaveDentalProtectItem(vData);
        }
        else if(this.flag_notify == 1)
        {
            theHosManage.theHosControl.theHosSubject.theScreeningDiseaseItemSubject.notifySaveScreeningDiseaseItem(vData);
        }
    }
    ...
    public void searchData()
    {
        ...
        vItem = theHosManage.theHosControl.theDentalProtectItemControl.selectItemByKeyword(keyword);
        showDataToTable(vItem);
        //System.out.println("------------showDataToTable(vItem);-----------------" + vItem);
        keyword = null;
    }   
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                new DialogSearchItemDrug(new javax.swing.JFrame(), true,theHosManage).setVisible(true);
            }
        });
    }
