...
import com.setupreport.object.NutritionLevel;
 ...
 * @author  Ojika
 */
public class DialogSearchNutrition extends javax.swing.JDialog {
    
    Vector vNutritionLevel,vData;
    HosManage theHosManage;
    TableModelGUI theTableModelGUI;
    NutritionLevel theNutritionLevel,theNutritionLevelTemp;
    String[] colName;
    int language = 1;
    /**สำหรับตรวจสอบว่าจะส่งค่าที่เลือกให้กับ Panel ใด*/
    int checkNotify;
    
    public DialogSearchNutrition(java.awt.Frame parent, boolean modal,HosManage hosmanage,int checknf) {
        super(parent, modal);
        ...
        this.setTitle(Language.getTextBundle("SearchNutrition",language));
        setLanguage();
    ...
    {   
        ...
        {   
            ...
            {
                theNutritionLevelTemp = (NutritionLevel)vNutritionLevel.get(rows[i]);
                vData.add(theNutritionLevelTemp);
                theNutritionLevelTemp = null;
            }
        }
        ...
        if(this.checkNotify == 1)
        {
            ...
            theHosManage.theHosControl.theHosSubject.theNutritionSubject.notifySaveNutritionMap(vData);
        }
    }    
    ...
    public void searchData()
    {
        ...
        vNutritionLevel = theHosManage.theHosControl.theNutritionControl.selectNutritionLevelByKeyword(keyword);
        showDataToTable(vNutritionLevel);
    ...
    private void showDataToTable(Vector vc)
    {
        ...
        if(vc != null)
        {
            ...
            for(int i = 0 ; i < size ;i++)
            {   
                theNutritionLevelTemp = (NutritionLevel)vc.get(i);
                theTableModelGUI.setValueAt(theNutritionLevelTemp.f_visit_nutrition_level_id,i, 0);
                theTableModelGUI.setValueAt(theNutritionLevelTemp.visit_nutrition_level_description,i, 1);
