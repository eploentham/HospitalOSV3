 ...
 *
 * Created on 28 ตุลาคม 2548, 11:42 น.
 */
 ...
 */
public class DialogSearchItemDrug extends javax.swing.JDialog {
    ...
    public DialogSearchItemDrug(java.awt.Frame parent, boolean modal,HosManage hosmanage) {
        super(parent, modal);
        ...
        this.setTitle(Language.getTextBundle("SearchDrug",language));
        setLanguage();
    ...
    {   vData = new Vector();
        ...
        theHosManage.theHosControl.theHosSubject.theAntibioticSubject.notifyShowItemDrug(vData);
    }    
    
    public void searchData()
    {
        String search = this.jTextFieldSearch.getText().trim();
        vItem = theHosManage.theHosControl.theAricAntibioticControl.selectItemDrugBySearch(search);
