...
public class CellRendererReport implements TableCellRenderer{
    private JLabel lblReportCheck = new JLabel(new ImageIcon(getClass().getResource("/com/setupreport/gui/utility/table/images/report_action.jpg")));
    private JLabel lblReport = new JLabel(new ImageIcon(getClass().getResource("/com/setupreport/gui/utility/table/images/report.jpg")));
