...
public class PanelRegisterNCD extends javax.swing.JPanel
{
    ...
    private Vector vNCDGroup = new Vector();
    ...
    public void initDialog()
    {
        ...
        theJD.setTitle(Constant.getTextBundle("มารักษากลุ่มโรค NCD"));
    ...
    // เรียกใช้จาก PanelSocialData sumo 28/08/2549
    public boolean showDialog(boolean pt,boolean vs,Vector vNCD)
    {
        this.vNCDGroup = vNCD;
        set_patient = pt;
        set_visit = vs;
    ...
    private void initComponents() {
        ...
        jComboBoxNCDGroup.setMinimumSize(new java.awt.Dimension(180, 21));
        ...
        integerTextFieldNumber.setMinimumSize(new java.awt.Dimension(40, 21));
        integerTextFieldNumber.setPreferredSize(new java.awt.Dimension(40, 21));
        gridBagConstraints = new java.awt.GridBagConstraints();
...
//        if(set_patient == false)
//        {
//            result = theHC.theVisitControl.saveVisitNCD(theNCD,jCheckBoxNCD.isSelected());
//        }
//        //มาจากการเรียกใช้ Dialog ของแถบข้อมูลผู้ป่วย sumo 31/08/2549
//        else
//        {
//            //ตรวจสอบการเลือกข้อมูลที่ซ้ำกัน sumo 31/08/2549
//            boolean ncd_repeated = false;
//            for(int i=0,size=vNCDGroup.size();i<size;i++)
//            {
//                NCD theNCDcheck = (NCD)vNCDGroup.get(i);
//                if(theNCD.ncd_group_id.equals(theNCDcheck.ncd_group_id)){
//                    ncd_repeated = true;
//                    break;
//                }
//            }
//            if(ncd_repeated == false) {
//                vNCDGroup.add(theNCD);
//            }
//            result = 1;
//        }
    }
    ...
    { 
        jLabel3.setText(Constant.getTextBundle("หากไม่กรอกข้อมูล หมายเลข NCD ที่จะได้คือ") 
                + " " +
    ...
    public void setLanguage(String msg)
    {
        ...
        GuiLang.setLanguage(jButtonAbort);
