/*
 * PanelSDSetupDrugInstruction.java
 *
 * Created on April 1, 2009, 5:12 PM
 */
 ...
 */
public class PanelSDDrugInstruction extends javax.swing.JPanel  implements PanelSetupImp{
    UpdateStatus theUS;
    ...
    /** Creates new form PanelSDSetupDrugInstruction */
    public PanelSDDrugInstruction() {
        initComponents();
        setLanguage();
    }
    
     public PanelSDDrugInstruction(HosControl hc,UpdateStatus us)
    {
        initComponents();
        setLanguage();
        setControl(hc,us);
    ...
    public void clearAll() {
        this.setTheDrugInstruction(new DrugInstruction());
    }

    public Persistent getXPer() {
        return this.getTheDrugInstruction();
    }

    public void setXPer(Persistent x) {
        this.setTheDrugInstruction((DrugInstruction)x);
    }
    ...
    public boolean deleteXPer(Persistent x) {
        return (this.theSetupControl.deleteDrugInstruction((DrugInstruction)x)>0);
    }

    public boolean saveXPer(Persistent x) {
        return (this.theSetupControl.saveDrugInstruction((DrugInstruction)x)>0);
    }

    public Vector listXPer(String key, String active, int offset) {
        return theSetupControl.listDrugInstructionByCNA(key,active);
    }
    ...
    public static String TITLE = Constant.getTextBundle("วิธีการใช้ยา");
    public String getTitle() {
        return TITLE;
    }

    public DrugInstruction getTheDrugInstruction() {
    ...
    public void setTheDrugInstruction(DrugInstruction item) {
        theDrugInstruction = item;
        jTextFieldCode.setText(theDrugInstruction.drug_instruction_id);
        jTextFieldDescription.setText(theDrugInstruction.description);
        if(theDrugInstruction.active!=null&&theDrugInstruction.active.equals("1"))
