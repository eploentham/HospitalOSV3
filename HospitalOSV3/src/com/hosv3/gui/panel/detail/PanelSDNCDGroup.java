/*
 * PanelSDSetupNCDGroup.java
 *
 * Created on April 2, 2009, 10:24 AM
 */

package com.hosv3.gui.panel.detail;

import com.hospital_os.object.NCDGroup;
import com.hospital_os.usecase.connection.Persistent;
import com.hosv3.utility.Constant;
import com.hospital_os.utility.Gutil;
import com.hosv3.control.HosControl;
import com.hosv3.control.SetupControl;
import com.hosv3.control.lookup.ChronicLookup;
 ...
 */
public class PanelSDNCDGroup extends javax.swing.JPanel  implements PanelSetupImp{
   UpdateStatus theUS;
    HosControl theHC;
    SetupControl theSetupControl;
    private NCDGroup theNCDGroup;
    ...
    public PanelSDNCDGroup(HosControl hc,UpdateStatus us) 
    {
        initComponents();
        setLanguage();
        setControl(hc,us);        
    ...
    private void initComponents() {
        ...
        jPanel2.setMaximumSize(new java.awt.Dimension(300, 140));
    ...
    public void clearAll() {
        this.setTheNCDGroup(new NCDGroup());
    }

    public Persistent getXPer() {
        return this.getTheNCDGroup();
    }

    public void setXPer(Persistent x) {
        this.setTheNCDGroup((NCDGroup)x);
    }
    ...
    public boolean deleteXPer(Persistent x) {
        return (this.theSetupControl.deleteNCDGroup((NCDGroup)x)>0);
    }

    public boolean saveXPer(Persistent x) {
        return (this.theSetupControl.saveNCDGroup((NCDGroup)x)>0);
    }

    public Vector listXPer(String key, String active, int offset) {
        return theSetupControl.listNCDGroupAll(key);
    }
    ...
    public static String TITLE = Constant.getTextBundle("โรค NCD");
    public String getTitle() {
        return TITLE;
    }

    public NCDGroup getTheNCDGroup() {
         if(theNCDGroup==null)
    ...
    public void setTheNCDGroup(NCDGroup item) {
        theNCDGroup = item;
