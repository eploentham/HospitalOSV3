/*
 * PanelSDSetupXRayLeteral.java
 *
 * Created on April 3, 2009, 10:58 AM
 */

package com.hosv3.gui.panel.detail;

import com.hospital_os.object.XRayLeteral;
 ...
 */
public class PanelSDXRayLeteral extends javax.swing.JPanel implements PanelSetupImp{
    UpdateStatus theUS;
    SetupControl theSetupControl;
    private XRayLeteral theXRayLeteral;
    ...
    public PanelSDXRayLeteral(HosControl hc,UpdateStatus us) {
        initComponents();
        setLanguage();
        setControl(hc,us);
    }
    public PanelSDXRayLeteral() {
        initComponents();
        setLanguage();
    }
    ...
    public void clearAll() {
        this.setTheXRayLeteral(new XRayLeteral());
    }

    public Persistent getXPer() {
        return this.getTheXRayLeteral();
    }

    public void setXPer(Persistent x) {
        this.setTheXRayLeteral((XRayLeteral)x);
    }
    ...
    public void setupLookup() {
     ...
     public boolean deleteXPer(Persistent x) {
        return (this.theSetupControl.deleteXrayLeteral((XRayLeteral)x)>0);
    }

    public boolean saveXPer(Persistent x) {
       //return false;
      return (this.theSetupControl.saveXrayLeteral((XRayLeteral)x)>0);
    }

    public Vector listXPer(String key, String active, int offset) {
        return theSetupControl.listXrayLeteralBySearch(key.toUpperCase(),active);
    }
    ...
    public boolean isActiveVisible() {
      ...
      public static String TITLE = Constant.getTextBundle("ด้านของการฉาย X-Ray");
    public String getTitle() {
        return TITLE;
    }

    public XRayLeteral getTheXRayLeteral() {
    ...
    public void setTheXRayLeteral(XRayLeteral item) {
        theXRayLeteral = item;
         jTextFieldCode.setText(theXRayLeteral.xray_leteral_id);
        jTextAreaName.setText(theXRayLeteral.description);
        
        if((theXRayLeteral.active)!=null&&(theXRayLeteral.active).equals("1"))
