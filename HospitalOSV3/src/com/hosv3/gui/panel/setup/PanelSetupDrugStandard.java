...
/////////////////////Use this for decrease memory usage
    ...
    private void jTextFieldSCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldSCodeActionPerformed
        //pu : 28/08/2549 : กำหนดค่าให้กับ Index สำหรับระบุถึงหน้าปัจจุบันของรายการ
        this.curNext = 0;
        this.curPrev = 0;
        search();         
    ...
    private void search()
    {   //pu : 28/08/2549 : กำหนดค่า Index ให้กับหน้าที่ต้องการแสดงรายการ
        next = this.curNext;
        prev =  this.curPrev;
    ...
    private void save()
    {
        ...
        if(ret==0)
            return;
        setEnableAll(false);
        //pu : 28/08/2549 : เก็บ Index ปัจจุบันของหน้ารายการที่กำลังบันทึก
        int count = next - prev;
        this.curNext = next - count;
        this.curPrev = prev - offset;
        search();
