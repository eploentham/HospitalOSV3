...
/////////////////////Use this for decrease memory usage
    ...
    /*** method สำหรับแสดง Dialog ในการค้นหาจำนวนยาที่ใช้ สำหรับพิมพ์***/
    private void showDoseMapUom()
    {
        if(thePanelSetupSearchSub==null)
        {
            if(theUom != null && theUom.getObjectId() != null){
               ...
               thePanelSetupSearchSub.setTitle(Constant.getTextBundle("แสดงรายการจำนวนยาที่ใช้ สำหรับการพิมพ์"));
               ...
               theUS.setStatus("กรุณาเลือกหน่วยยา",UpdateStatus.WARNING);
            }
       }
        thePanelSetupSearchSub = null;
    }
    
    /*** method สำหรับนำค่าของจำนวนยาทีใช้ในการพิมพ์ ที่ผูกกับหน่วยมาแสดง ***/
    ...
    /*** method สำหรับนำค่าของ DrugDoseMapUom มาแสดงในตาราง ***/
