 ...
 * @author henbe
 */
public class BalloonTextField2 extends JTextField 
        implements KeyListener,FocusListener,ManageBalloon{
    ...
    public BalloonTextField2(JFrame jf)
    {
        addKeyListener(this);
        setJFrame(jf);
    }
    private void jTextFieldFocusLost(java.awt.event.FocusEvent evt) {          
        Constant.println("private void jTextFieldFocusLost(java.awt.event.FocusEvent evt) {");
    }                     
    /**
...
//            balloon.setVisible(false);
    ...
    public void setBalloonVisible(boolean b){
        balloon.setVisible(b);
    }
    ...
    public void setControl(LookupControlInf c,JFrame jf){
        controle = c;
        setJFrame(jf);
    }
    ...
    public static void showPopup()
    {
        ...
        BalloonTextField2 pnl = new BalloonTextField2();
        pnl.setSelectAround("","\n");
        pnl.setControl(vtl);
        pnl.setJFrame(jp);
        jp.getContentPane().setLayout(new java.awt.BorderLayout());
        ...
        public void setTable(Vector v){
            ...
            if(v == null || vsize == 0){
                ...
                for(int i=0;i<vsize;i++){
                    if(v.get(i) instanceof com.hospital_os.object.Item)
                        tm.setValueAt(((com.hospital_os.object.Item)v.get(i)).getName(),i,0);
                    else
