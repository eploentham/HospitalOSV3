...
// TODO add your handling code here:
    ...
    public Vector getGuideV()
    {
        ...
        if(jCheckBoxHEPerson.isSelected())
            getGuideHealth(vGuide,"สุขศึกษารายบุคคล",jTextFieldHEPerson.getText());
        if(jCheckBoxHEGroup.isSelected())
            getGuideHealth(vGuide,"สุขศึกษารายกลุ่ม",jTextFieldHEGroup.getText());
        if(jCheckBoxHEFamily.isSelected())
            getGuideHealth(vGuide,"สุขศึกษารายครอบครัว",jTextFieldHEFamily.getText());
        if(jCheckBoxDMethod.isSelected())
            getGuideHealth(vGuide,"D-Method โรค",jTextFieldDMethod.getText());
        if(jCheckBoxHomeVisit.isSelected())
            getGuideHealth(vGuide,"นัด Home visit",jTextFieldHomeVisit.getText());
        if(jCheckBoxHomeHealthCare.isSelected())
            getGuideHealth(vGuide,"นัด Home health care",jTextFieldHomeHealthCare.getText());
        if(jCheckBoxOther.isSelected())
            getGuideHealth(vGuide,"อื่นๆ",jTextFieldOther.getText());
        if(jCheckBoxExercise.isSelected())
            getGuideHealth(vGuide,"การออกกำลังกาย","");
        if(jCheckBoxFood.isSelected())
            getGuideHealth(vGuide,"การควบคุมอาหาร","");
        if(jCheckBoxMySelf.isSelected())
            getGuideHealth(vGuide,"การปฏิบัติตนทั่วไป","");
        if(jCheckBoxDrug.isSelected())
            getGuideHealth(vGuide,"การใช้ยาที่ถูกต้อง","");
        if(jCheckBoxRelax.isSelected())
            getGuideHealth(vGuide,"การพักผ่อนและลดความเครียด","");
        if(jCheckBoxAppoint.isSelected())
            getGuideHealth(vGuide,"การมาตรวจตามนัด","");
        if(jCheckBoxHerb.isSelected())
            getGuideHealth(vGuide,"สมุนไพรที่เกี่ยวข้อง","");
        if(jCheckBoxDisease.isSelected())
            getGuideHealth(vGuide,"การให้ความรู้เรื่องโรคและภาวะแทรกซ้อน","");
        return vGuide;
    } 
