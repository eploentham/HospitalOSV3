 ...
 *@author by  : pee
 */
public class PanelSRiskFactorTemplate extends javax.swing.JPanel
{
    UpdateStatus theUS;
   public RiskFactorTemplate theRiskFactorTemplate = new RiskFactorTemplate();
   public Vector vRiskFactorTemplate;
   
   public SetupControl theSetupControl;
   public LookupControl theLookupControl;
   String[] col = {GuiLang.setLanguage("ชื่อโรค")};
   
    /** Creates new form SetupRiskFactorTemplate */
    public PanelSRiskFactorTemplate() {
        initComponents();
    }
    public PanelSRiskFactorTemplate(HosControl hc,UpdateStatus us){
        initComponents();
	setControl(hc,us);
    }
    ////////////////////////////////////////	
    ...
    private void initComponents() {
        ...
        setBorder(new javax.swing.border.TitledBorder("\u0e1b\u0e31\u0e08\u0e08\u0e31\u0e22\u0e40\u0e2a\u0e35\u0e48\u0e22\u0e07"));
...
//        theSetupControl.deleteRiskFactorTemplate(getRiskFactorTemplate());
...
//            Vector vList = theLookupControl.listRiskFactorTemplate(jTextFieldKeyword.getText());
//            setRiskFactorTemplate(vList);
        }        
    ...
    private void jTextFieldKeywordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldKeywordActionPerformed
        RiskFactorTemplate dt = new RiskFactorTemplate();
        dt.name = jTextFieldKeyword.getText();
//        theSetupControl.saveRiskFactorTemplate(dt);
...
//         this.theSetupControl.deleteRiskFactorTemplate(getRiskFactorTemplate());
//         Vector vList = theLookupControl.listRiskFactorTemplate(jTextFieldKeyword.getText());
//         setRiskFactorTemplate(vList);
    ...
    public RiskFactorTemplate getRiskFactorTemplate()
    {
        int row = this.jTable1.getSelectedRow();
        RiskFactorTemplate dt = (RiskFactorTemplate)vRiskFactorTemplate.get(row);
        return dt;
    }

    public void setRiskFactorTemplate(Vector voffice)
    {
        vRiskFactorTemplate = voffice;
        if(vRiskFactorTemplate==null)
            vRiskFactorTemplate = new Vector();
        TaBleModel tm = new TaBleModel(col,vRiskFactorTemplate.size());
        for(int i=0,size=vRiskFactorTemplate.size();i<size;i++)
        {
            RiskFactorTemplate pp = (RiskFactorTemplate)vRiskFactorTemplate.get(i);   
