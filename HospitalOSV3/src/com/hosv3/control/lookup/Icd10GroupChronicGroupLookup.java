 ...
 * @author  sumo
 */
public class Icd10GroupChronicGroupLookup implements LookupControlInf,ExecuteControlInf{
    ...
    public Icd10GroupChronicGroupLookup(LookupControl lookup) {
        theLookup = lookup;
    }
    
    public Icd10GroupChronicGroupLookup(SetupControl lookup)
    {
        is_lookup = false;
        theEC = lookup;
    }
    ...
    public boolean execute(Object str) {
        theEC.addICD10GCGroup((ICD10)str);
        return true;
    }
