 ...
 */
public class R53EpiVccTypeLookup implements LookupControlInf{
    private final ConnectionInf theConnectionInf;
    private Vector vret;
    /** Creates a new instance of AccidentTypeLookup */
    public R53EpiVccTypeLookup(ConnectionInf con){
    ...
    public java.util.Vector listData(String str) {
        try {
            ...
            ResultSet rs = theConnectionInf.eQuery(
                    "select * from (select id,name || ' '||description || ' '||type||' สำหรับ '||age as des " +
                    " from r_rp1853_vcctype) instype " +
