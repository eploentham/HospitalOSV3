...
select 				
	...
	, case when (t_health_anc.health_anc_exam='1'
                    or t_health_anc.health_anc_exam='2')
            then t_health_anc.health_anc_exam else '' end AS ANCRES
...
FROM t_health_anc			
	...
	LEFT JOIN t_health_family ON t_health_anc.t_health_family_id = t_health_family.t_health_family_id      			
