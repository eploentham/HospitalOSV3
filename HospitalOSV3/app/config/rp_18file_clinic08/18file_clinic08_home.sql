SELECT 
	 b_site.b_visit_office_id || substring( t_health_home.t_health_home_id,9) as ID
	...
	, CASE WHEN t_health_home.health_home_owner = family_ower.patient_pid
            THEN family_ower.health_family_hn_hcis
            ELSE t_health_home.health_home_owner  END AS HEADID                
...
from  t_health_home 
	...
	left join t_health_family as family_ower ON family_ower.patient_pid = t_health_home.health_home_owner
    ,b_site
