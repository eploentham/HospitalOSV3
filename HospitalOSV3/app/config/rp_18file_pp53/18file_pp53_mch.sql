...
SELECT  
	b_site.b_visit_office_id AS PCUCODE  --NOT NULL
        , t_health_family.patient_pid as CID --NOT NULL --µéÍ§ãªéàª×èÍÁâÂ§¡Ñº 12 á¿éÁ
	...
	, min(CASE WHEN (t_health_anc.health_anc_vdrl ='0'  
                        ...
                        OR t_health_anc.health_anc_vdrl is null) then '8' --ï¿½ï¿½ï¿½ï¿½Ç¨
               WHEN t_health_anc.health_anc_vdrl ='3' then '9' --ï¿½Í¼Åµï¿½Ç¨
	...
	, min(CASE WHEN (t_health_anc.health_anc_hb ='0' 
            ...
            WHEN t_health_anc.health_anc_hb ='3' then '9' --ï¿½Í¼Åµï¿½Ç¨                  
	...
	, min(CASE WHEN (t_health_anc.health_anc_hiv ='0'
                ...
                WHEN t_health_anc.health_anc_hiv ='3' then '9' --ï¿½Í¼Åµï¿½Ç¨     
	...
	, min(CASE WHEN (t_health_anc.health_anc_thalassemia ='0' 
                ...
                WHEN t_health_anc.health_anc_thalassemia ='3' then '9' --ï¿½Í¼Åµï¿½Ç¨     
	...
	, min(CASE WHEN (t_health_anc.health_anc_dental_exam=''
                ...
                OR t_health_anc.health_anc_dental_exam ='0') THEN '0' --ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ç¨
...
group by pcucode,cid,gravida,lmp,edc,bdate,bresult,bplace,bhosp,btype
