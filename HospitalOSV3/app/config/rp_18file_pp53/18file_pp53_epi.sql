...
(SELECT
    ...
    --CID ต้องสร้างเลข 13 หลักของ ผู้รับบริการที่เป็นต่างด้าว เพราะว่าสามารถส่งข้อมูลได้
        --การคิดให้เอาเลขรหัสต่างด้าวเดิม คือ 234 มาต่อกับเลขรันนิ่งของ t_health_family_id
        , case when (t_patient.f_patient_foreigner_id in ('2','3','4')
          ...
          end as CID --NOT NULL --ต้องใช้เชื่อมโยงกับ 12 แฟ้ม
...
SELECT
	...
	,t_health_epi.t_health_epi_id AS SEQ
...
,t_health_epi_outsite.t_health_epi_outsite_id as SEQ
