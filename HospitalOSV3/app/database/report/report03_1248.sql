-- เปลี่ยนข้อมูลเพราะปีงบประมาณ 2549 เพิ่มข้อมูลสิทธิ รง5
DROP TABLE r_uc_plan_group;
-- โครงสร้างจาก 292 ผิดอยู่
DROP TABLE s_report_version;
-- ข้อมูลรหัสเดิมผิดอยู่
DROP TABLE r_rp504_disease_code;
-- ข้อมูลรหัสเดิมผิดอยู่
DROP TABLE r_rp505_disease_code;
...
-- เปลี่ยนข้อมูลในตาราง r_rp504_disease_code 
...
-- เปลี่ยนข้อมูลในตาราง r_rp505_disease_code
