...
--henbe modify 30/11/2549 เพราะว่ามันไปลบข้อมูล รายงานเดิมของโรงพยาบาลเขาออกหมดเลย
...
-- หากมีการลงข้อมูลไปแล้วจะมีผลกระทบนะ
...
--henbe modify 30/11/2549 เพราะว่ามันไปลบข้อมูล รายงานเดิมของโรงพยาบาลเขาออกหมดเลย
ALTER TABLE r_sql_template alter sql_template_sql type varchar(5000);
ALTER TABLE r_sql_template alter sql_template_is_query_by_date type varchar(255);

-- หากมีการบันทึก SQL ไปแล้วจะมีผลกระทบนะ
...
-- Version ของรายงานในตาราง s_report_version
INSERT INTO s_report_version VALUES ('8170000000001', '01', 'Report Center', '1.00.1048', 'for hospitalOS v3 db : 3.13.1048 and pcu db : 0.02.1048', '2548-10-14 14:45:00');
