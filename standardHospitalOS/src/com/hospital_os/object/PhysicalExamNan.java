...
{ 
    ...
    public PhysicalExamNan(Vector v){
        setPhysicalExamV(v);
    }
    /**
    ...
    public String getText(){
        Vector v = getForTextArea(null);
        String v_out = PhysicalExam.getForTextArea(v);
        return v_out;
    }
    public Vector getForTextArea(Vector v)
    {
        Vector vPhysicalExam = new Vector();
        if(v!=null)
            vPhysicalExam = setPhysicalExamV(v);
        ...
        initPhysicalExam(vPhysicalExam,"GA", "GCS E" + ga_gcs_e + " M" + ga_gcs_m + " V"+ ga_gcs_v ,ga_gcs	);
        ...
        initPhysicalExam(vPhysicalExam,"Heart","Area",hea_mur_sys_area,hea_mur_sys, hea_mur	);
        initPhysicalExam(vPhysicalExam,"Heart","murmur diastolic Grade",hea_mur_dias_gra,hea_mur_dia, hea_mur);
        initPhysicalExam(vPhysicalExam,"Heart","Area",hea_mur_dias_area,hea_mur_dia, hea_mur);
        //Constant.println("hea_no_mur"+hea_no_mur);
        initPhysicalExam(vPhysicalExam,"Heart","no murmur",	hea_no_mur	);
        //initPhysicalExam(vPhysicalExam,"Heart"," ",this.hea_oth,"1");
        ...
        initPhysicalExam(vPhysicalExam,"Lung"," ",lung_oth,"1");
    ...
    public Vector getPhysicalExamV()
    {
        ...
        initPhysicalExam(vPhysicalExam,"GA", "dyspnea", 	ga_dys	);
        initPhysicalExam(vPhysicalExam,"GA", "tachpnea", 	ga_tach	);
        initPhysicalExam(vPhysicalExam,"GA", "other", 	ga_other,"1");
        initPhysicalExam(vPhysicalExam,"HEENT",	"normal", hee_normal	);
        initPhysicalExam(vPhysicalExam,"HEENT","pale conjunctiva",	hee_pale	);
        initPhysicalExam(vPhysicalExam,"HEENT","not pale conjunctiva",	hee_not_pa	);
        initPhysicalExam(vPhysicalExam,"HEENT","inject pharynx",	hee_inj	);
        ...
        initPhysicalExam(vPhysicalExam,"Heart","no murmur",	hea_no_mur	);
        //initPhysicalExam(vPhysicalExam,"Heart","other",hea_oth,"1");
        initPhysicalExam(vPhysicalExam,"Lung","Clear",	lung_cle	);
        ...
        initPhysicalExam(vPhysicalExam,"Lung","Crepitation coarse Position",	lung_cre_coa_pos,lung_cre_coa	);
        initPhysicalExam(vPhysicalExam,"Lung","other",lung_oth,"1");
        initPhysicalExam(vPhysicalExam,"Abdomen","contour normal",	abd_con_nor	);
        initPhysicalExam(vPhysicalExam,"Abdomen","contour distend",	abd_con_dis	);
        initPhysicalExam(vPhysicalExam,"Abdomen","contour scaphoid",	abd_con_sca	);
        initPhysicalExam(vPhysicalExam,"Abdomen","bowel sound normal",	abd_bow_nor	);
        ...
        initPhysicalExam(vPhysicalExam,"Abdomen","เคาะ ทึบ",abd_kok_dark	);
        initPhysicalExam(vPhysicalExam,"Abdomen","เคาะ โปร่ง",abd_kok_clr	);
        initPhysicalExam(vPhysicalExam,"Abdomen","other",abd_pal_oth,"1");
        initPhysicalExam(vPhysicalExam,"Skin","normal",skin_nor	);
        initPhysicalExam(vPhysicalExam,"Skin","bullous",skin_bul);
        initPhysicalExam(vPhysicalExam,"Skin","tined",skin_tin	);
        initPhysicalExam(vPhysicalExam,"Skin","eczema",	skin_ecz);
        ...
        initPhysicalExam(vPhysicalExam,"Skin","pustula",skin_pus);
        initPhysicalExam(vPhysicalExam,"Skin","scale",skin_sca);
        initPhysicalExam(vPhysicalExam,"Skin","other",skin_oth,"1");
        initPhysicalExam(vPhysicalExam,"Extremity","normal",ext_nor	);
        initPhysicalExam(vPhysicalExam,"Extremity","pitting edema",ext_pit	);
        initPhysicalExam(vPhysicalExam,"Extremity","non pitting edema",	ext_non_pit	);
        initPhysicalExam(vPhysicalExam,"Extremity","tender",ext_ten	);
        initPhysicalExam(vPhysicalExam,"Extremity","tender at",ext_ten_dec,ext_ten	);
        initPhysicalExam(vPhysicalExam,"Extremity","other",ext_oth,"1"	);
        initPhysicalExam(vPhysicalExam,"Neuro","Grossly intact",neu_gro	);
        ...
        initPhysicalExam(vPhysicalExam,"Neuro","Reflex R ",neu_ref_r_vol,neu_ref_r);
        initPhysicalExam(vPhysicalExam,"Neuro","other",neu_oth,"1"	);
        initPhysicalExam(vPhysicalExam,"Others (describe)"," ",others,"1"	);

        return vPhysicalExam;
    }
    public void printValue(){
        Vector v = this.getPhysicalExamV();
        for(int i=0;i<v.size();i++){
            PhysicalExam phe = (PhysicalExam)v.get(i);
            if(!phe.detail.equals(""))
                Constant.println("__" + phe.physical_body + "::" + phe.detail);
        }
    ...
    public String getValue(PhysicalExam pe,String detail){
        int index = 0;
        if(!detail.equals(""))
            index = pe.detail.indexOf(detail)+ detail.length()+1;
     ...
     */
    public Vector setPhysicalExamV(Vector v)
    {
        if(v==null)
            v = new Vector();
        ...
        {    
            ...
            else if(isMatch(pe,"GA","GCS E")) {	
                ga_gcs_e	 = getValue(pe, "GCS E");   
                ga_gcs = "1";
            }
            else if(isMatch(pe,"GA","GCS M")) {
                ga_gcs_m	 = getValue(pe, "GCS M");   
                ga_gcs = "1";
            }
            else if(isMatch(pe,"GA","GCS V")) {
                ga_gcs_v	 = getValue(pe, "GCS V");   
                ga_gcs = "1";
            }
            ...
            else if(isMatch(pe,"GA","other")) {	ga_other    = getValue(pe, "other");   }
            ...
            else if(isMatch(pe,"HEENT","eye pterygium Position")) {	
                hee_eye_pter_pos = getValue(pe, "eye pterygium Position"); 
                hee_eye_pter= "1";
            }
            else if(isMatch(pe,"HEENT","eye pterygium")) {		hee_eye_pter= "1";   }
            else if(isMatch(pe,"HEENT","eye inject conjuctiva Position")) {
                hee_eye_inj_pos = getValue(pe, "inject conjuctiva Position");   
                hee_eye_inj= "1";   
            }   
            else if(isMatch(pe,"HEENT","eye inject conjuctiva")) {	hee_eye_inj= "1";   }
            else if(isMatch(pe,"HEENT","eye opaque len Position")) {	
                hee_eye_opa_pos= getValue(pe, "eye opaque len Position");  
                hee_eye_opa= "1";
            }
            else if(isMatch(pe,"HEENT","eye opaque len")) {		hee_eye_opa= "1";   }
            else if(isMatch(pe,"HEENT","eye hordeolum Position")) {	
                Constant.println("else if(isMatch(pe,HEENTeye hordeolum Position)) {	");
                hee_eye_her_pos= getValue(pe, "eye hordeolum Position").trim();    
                hee_eye_her= "1";
                Constant.println("else if(isMatch(pe,HEENTeye hordeolum Position)) {	"+hee_eye_her_pos);
            }
            ...
            //else if(isMatch(pe,"Heart","other")) {	hea_oth= getValue(pe, "");}
            else if(isMatch(pe,"Lung","Clear")) {	lung_cle= "1";   }
            else if(isMatch(pe,"Lung","Wheezing Position")) {	
                lung_whe_pos = getValue(pe,"Wheezing Position");
                lung_whe= "1";
            }
            else if(isMatch(pe,"Lung","Wheezing")) {	lung_whe= "1";	}
            else if(isMatch(pe,"Lung","Rhonchi Position")) {	
                lung_rho_pos = getValue(pe,"Rhonchi Position");
                lung_rho = "1";
            }
            else if(isMatch(pe,"Lung","Rhonchi")) {	lung_rho = "1";	}
            else if(isMatch(pe,"Lung","Crepitation fine Position")) {
                lung_cre_fine_pos = getValue(pe,"Crepitation fine Position"); 
                lung_cre_fine = "1";
            }
            else if(isMatch(pe,"Lung","Crepitation fine")) {	lung_cre_fine = "1"; }
            else if(isMatch(pe,"Lung","Crepitation coarse Position")) {
                lung_cre_coa_pos =getValue(pe,"Crepitation coarse Position"); 
                lung_cre_coa ="1";
            }
            else if(isMatch(pe,"Lung","Crepitation coarse")) {	lung_cre_coa ="1"; }
            else if(isMatch(pe,"Lung","other")) {	lung_oth= getValue(pe, "other");}
            ...
            else if(isMatch(pe,"Abdomen","other")) {	abd_pal_oth= getValue(pe, "other");  }
            ...
            else if(isMatch(pe,"Skin","other")) {	skin_oth= getValue(pe, "other"); }
            ...
            else if(isMatch(pe,"Extremity","other")) {	ext_oth= getValue(pe, "other");   }
            ...
            else if(isMatch(pe,"Neuro","other")) {	neu_oth= getValue(pe, "other");   }
