...
public class VisitDB
{
    ...
    /**
     * 
     * @deprecated มันค้นจาก patient_id ไม่ใช่ Hn ผิดความหมายแต่ไม่รู้ว่าที่อื่นใช้หรือเปล่านะเลยไม่ลบก่อน
     */
...
//            p.visit_financial_record_staff = rs.getString(dbObj.visit_financial_record_staff);
	...
	.append( dbObj.table)
	.append( " where " ).append( dbObj.patient_id ).append( " = '").append( patient_id ).append( "'")
//        .append( " and " ).append( dbObj.visit_type ).append( " ='0'" )// Somprasong 090810 ทำให้แสดงทั้ง OPD& IPD
    ...
    /**
     * @deprecated ห้ามใช้ฟังชันนี้เด้ดขาด Out of Memory
     * @return
     * @throws Exception
     */
...
//          p.cause_appointment = Gutil.CheckReservedWords(p.cause_appointment);
   ...
   public int updateAge(Visit p) throws Exception
    ...
    /**
     *@deprecated ตั้งชื่อผิดรูปแบบต้องระบุว่าค้นโดยฟิลด์ไหน
     **/
...
//        System.out.println("p.diagnosis_note = " + p.diagnosis_note);
   ...
   //////////////////////////////////////////////////////////////////////////////
    // update ข้อมูลใน field visit_have_appointment sumo 07/08/2549
    ...
    //////////////////////////////////////////////////////////////////////////////
    // update ข้อมูลใน field visit_have_admit sumo 07/08/2549
    ...
    //////////////////////////////////////////////////////////////////////////////
    // update ข้อมูลใน field visit_have_refer sumo 07/08/2549
    ...
    //////////////////////////////////////////////////////////////////////////////
    // update ข้อมูลใน field t_patient_appointment_id,visit_cal_date_appointment และ visit_cause_appointment sumo 08/08/2549
