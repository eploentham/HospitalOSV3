...
public class AppointmentDB
{
     ...
     *@Author amp
     *@date 20/06/2549
     *@see ดึงนัดที่ตรงกับวันที่ visit
     */
     ...
     *@note: ใช้ method ร่วมกับ countAppointmentByDateAndDoctor เนื่องจากมีบาง record ที่แพทย์ผู้นัดเป็นช่องว่าง เล่นใน databse develop_hosv3
     */
     ...
     *@Author: henbe
     *@date: 7/7/2550
     *@see: คำนวณจำนวนของการนัดในแต่ละวันของแต่ละจุดบริการ
     *@param: วันที่นัด,Key_id ของ employee ของแพทย์ที่เลือก
     *@return: จำนวนการนัดของวันและจุดบริการที่ระบุ
     */
