...
//        String str_date = sdf.format(new Date(date_time.getTime()));
        String str_date = executeDate.substring(2, 10).replaceAll("-", "");
        ...
        sql = "select t_lis_ln.lab_number from t_lis_ln order by t_lis_ln.exec_datetime desc, t_lis_ln.rec_datetime desc, t_lis_ln.lab_number desc;";
