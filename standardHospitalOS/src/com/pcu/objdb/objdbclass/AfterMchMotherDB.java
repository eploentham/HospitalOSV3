...
public class AfterMchMotherDB {
    ...
    public boolean initConfig()
    {
        ...
        this.dbObj.place_hos = "postpartum_place_hos";
     ...
     * for new pcu
     */
    public int insertNP(AfterMchMother o) throws Exception
    {
        sql="";
    ...
    public int updateNP(AfterMchMother o) throws Exception
    {
        sql="update " + dbObj.table + " set ";
