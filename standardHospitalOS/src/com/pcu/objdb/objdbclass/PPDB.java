 ...
 * PPDB.java
 *
 * Created on 2 สิงหาคม 2548, 12:00 น.
 */
...
/////////////////////////////////////////////////////////////////////////////    
    ...
    public PP selectByFamilyIDAndGravida(String family_id,String gravida)  throws Exception {
        String sql="select * from " + dbObj.table + " where "
                + dbObj.family_id + " = '" + family_id + "' and "
                + dbObj.pp_active + " = '1' and "
                + dbObj.pp_gravida + " ='"+ gravida + "'" + " order by pp_gravida,pp_number" ;
    ...
    public PP readPPByPidAndGravida(String patient_id,String gravida)  throws Exception {
        String sql="select * from " + dbObj.table + " where "
                + dbObj.t_patient_id + " = '" + patient_id + "' and "
                + dbObj.pp_active + " = '1' and "
                + dbObj.pp_gravida + " ='"+ gravida + "'" + " order by pp_gravida,pp_number" ;
    ...
    public PP readPPByPidAndGravidaAndPPNumber(String patient_id,String gravida,String number)  throws Exception {
        String sql="select * from " + dbObj.table + " where "
                + dbObj.t_patient_id + " = '" + patient_id + "' and "
                + dbObj.pp_active + " = '1' and "
                + dbObj.pp_gravida + " ='"+ gravida + "' and " + dbObj.pp_number + " ='"+number+"'"
                + " order by pp_gravida,pp_number" ;
    ...
    public String getPPNumberByPidAndGravida(String patient_id,String gravida)  throws Exception {
        String pp_number = "";
        String sql="select * from " + dbObj.table + " where "
                + dbObj.t_patient_id + " = '" + patient_id + "' and "
                + dbObj.pp_active + " = '1' and "
                + dbObj.pp_gravida + " ='"+ gravida + "'"
                + " order by pp_number desc limit 1" ;
        ResultSet rs = theConnectionInf.eQuery(sql);
        if(rs.next())
            pp_number = rs.getString("pp_number");
        return pp_number;
    }
}
