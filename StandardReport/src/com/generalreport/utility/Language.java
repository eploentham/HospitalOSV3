...
public class Language {
    static final String thai = "com/standardReport/property/Thai";
    static final String eng = "com/standardReport/property/eng";
    ...
    {
        System.out.println(Language.getTextThaiBundle("Sequence"));
    }
}
