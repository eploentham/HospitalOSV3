  ...
  public static String getGuiData(JTextField j) {
   ...
   public static boolean setGuiData(JTable jt,Vector v,String code)
    ...
    {   //Deus: modified for localization.
        ...
        try{
            return java.util.ResourceBundle.getBundle("com/standardReport/property/Thai").getString(str);
        }catch(Exception e){ 
  ...
  //   System.out.println(un);
   ...
   //     {
    ...
    public static String changDateToString(String date,boolean showTime) {
        return com.hospital_os.utility.Gutil.getDateToString(com.hospital_os.utility.Gutil.getDateFromText(date), showTime);
    }
}
