 ...
 *
 * Created on 5 ตุลาคม 2548, 15:57 น.
 */
 ...
 * @author  americus
 */
public class PanelReportCostPayment extends javax.swing.JPanel implements 
GUIControl,ManageGUI,Runnable,ManageAllPanel
{
    ...
    public PanelReportCostPayment(HosManage hosmanage)
    {
    ...
    private void queryDataByDate(String startDate, String endDate)
    {
        ...
        vcData = theHosManage.theHosControl.theRPCostPaymentControl.selectCostPaymentByDate(startDate,endDate,isDbBackup);
