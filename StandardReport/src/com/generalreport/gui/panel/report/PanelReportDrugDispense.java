 ...
 *
 * Created on 5 ตุลาคม 2548, 11:57 น.
 */
 ...
 * @author  americus
 */
public class PanelReportDrugDispense extends javax.swing.JPanel implements 
GUIControl,ManageGUI,Runnable,ManageAllPanel
{
    ...
    public PanelReportDrugDispense(HosManage hosmanage)
    {
    ...
    private void queryDataByDate(String startDate, String endDate)
    {
        ...
        vcData = theHosManage.theHosControl.theRPDrugDispenseControl.selectDrugDispenseByDate(startDate,endDate,isDbBackup);
    ...
    private void setTableListReportPattern(String [] col)
    {
        ...
        for(int i=0;i<col_number.length;i++)
        {
            ...
            {
                jTableShow.getColumnModel().getColumn(i).setPreferredWidth(180);
            }
        }
    }
