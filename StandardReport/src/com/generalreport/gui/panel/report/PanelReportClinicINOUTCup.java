/*
 * PanelReportClinicINOUTCup.java
 *
 ...
 */
public class PanelReportClinicINOUTCup  extends javax.swing.JPanel implements 
GUIControl,ManageGUI,Runnable,ManageAllPanel
{
    ...
    public PanelReportClinicINOUTCup(HosManage hosmanage)
    {
    ...
    private void initComponents()
    {
        ...
        jPanelClinicINOUTCup = new javax.swing.JPanel();
        jScrollPanelClinicINOUTCup = new javax.swing.JScrollPane();
        jTableShow = new javax.swing.JTable();

        setLayout(new java.awt.BorderLayout());

        jPanelClinicINOUTCup.setLayout(new java.awt.GridBagLayout());
        ...
        jScrollPanelClinicINOUTCup.setViewportView(jTableShow);
        ...
        jPanelClinicINOUTCup.add(jScrollPanelClinicINOUTCup, gridBagConstraints);

        add(jPanelClinicINOUTCup, java.awt.BorderLayout.CENTER);
    ...
    private void queryDataByDate(String startDate, String endDate)
    {
        ...
        vcData = theHosManage.theHosControl.theRPClinicINOUTCupControl.selectClinicINOUTCupByDate(startDate,endDate,isDbBackup);
    ...
    private javax.swing.JPanel jPanelClinicINOUTCup;
    private javax.swing.JScrollPane jScrollPanelClinicINOUTCup;
