 ...
 *
 * Created on 3 ตุลาคม 2548, 17:36 น.
 */

package com.generalreport.gui.panel;

import com.generalreport.gui_component.CellRendererToolTipText;
...
public class PanelReportIndex extends javax.swing.JPanel {
    ...
    public void setLanguage()
    {
        ...
        headColumn[0] = Language.getTextBundle("Sequence", language);
        headColumn[1] = Language.getTextBundle("ReportName", language);
        headColumn[2] = Language.getTextBundle("Description", language);
        
        jButtonOK.setText(Language.getTextBundle(jButtonOK.getText(),language));
        
        jPanelMainReport.setBorder(new javax.swing.border.TitledBorder(Language.getTextBundle("GeneralReport",language)));
