/*
 * DefaultThaiMetalTheme.java
 *
 * Created on 28 กรกฎาคม 2548, 15:07 น.
 */
 ...
 * @author Noom
 */
public class DefaultThaiMetalTheme extends MetalTheme{
    ...
    //private final ColorUIResource  primary1 = new ColorUIResource(204, 204, 204);
    ...
    //private final ColorUIResource  secondary3 = new ColorUIResource(204, 204, 210);
    
    /**/
    private FontUIResource  controlFont;
    private FontUIResource  controlFontMenu;
    private FontUIResource  systemFont;
    private FontUIResource  userFont;
    private FontUIResource  smallFont;
    public DefaultThaiMetalTheme() {
        controlFont = new FontUIResource( Font.getFont( "swing.plaf.metal.controlFont", new Font("Tahoma", Font.PLAIN, 11) ) );
        systemFont  = new FontUIResource( Font.getFont( "swing.plaf.metal.systemFont" , new Font("Tahoma", Font.PLAIN, 12) ) );
        userFont    = new FontUIResource( Font.getFont( "swing.plaf.metal.userFont"   , new Font("Tahoma", Font.PLAIN, 11) ) );
        smallFont   = new FontUIResource( Font.getFont( "swing.plaf.metal.smallFont"  , new Font("Tahoma", Font.PLAIN, 10) ) );
        controlFontMenu = new FontUIResource( Font.getFont( "swing.plaf.metal.controlFont", new Font("Tahoma", Font.PLAIN, 12) ) );
    }
    ...
    public FontUIResource  getMenuTextFont()     { return controlFontMenu; }
