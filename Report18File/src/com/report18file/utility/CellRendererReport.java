...
public class CellRendererReport implements TableCellRenderer{
    private JLabel lblReportCheck = new JLabel(new ImageIcon(getClass().getResource("/com/report18file/gui/images/report_action.jpg")));
    private JLabel lblReport = new JLabel(new ImageIcon(getClass().getResource("/com/report18file/gui/images/report.jpg")));
