 ...
 * Drug.java
 *
 * Created on 1 สิงหาคม 2548, 10:02 น.
 *
 ...
 * @author Noom
 */
public class Drug  implements Rp18OI{
...
"ราคาทุน"
    ...
    public boolean checkDatadict(StringBuffer sb,int[] error) {
        ...
        if(!Report18FileData.checkDataDict(	did 	,	6	,	true,false	)) { 	error[5	]++;    ret=false;}
        if(!Report18FileData.checkDataDict(	amount	,	12	,	false	)) { 	error[6	]++;    ret=false;}
        if(!Report18FileData.checkDataDict(	drugpric	,	14	,	false	)) { 	error[7	]++;    ret=false;}
        if(!Report18FileData.checkDataDict(	drugcost	,	14	,	false	)) { 	error[8	]++;    ret=false;}
    ...
    public PreparedStatement getPreparedStatement(Connection con, String startDate, String endDate, int mode) throws Exception {
        ...
        String sql = IOStream.readInputDefault("config/rp_18file/18file_drug.sql");
    ...
    public DBFField[] getDBFField() throws Exception {
        ...
        Report18FileData.initDBFField(5,header,fields,DBFField.FIELD_TYPE_C,12);
