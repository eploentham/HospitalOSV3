...
public class Report18File  implements ModuleInfTool
{
    ...
    String PANEL_SETUP_NATION_MAP = Constant.getTextBundle("จับคู่เชื้อชาติ/สัญชาติ");
    String PANEL_SETUP_EDUCATION_MAP = Constant.getTextBundle("จับคู่การศึกษา");
...
//        }
        ...
        {
            PanelMapLookup panel = new PanelMapLookup();
            panel.setTitle(PANEL_SETUP_NATION_MAP);
            panel.setControl(new MapControl(Report18FileData.MAP_NATION,theUS,theHC.theConnectionInf)
                    ,theUS,theHO);
            vSetupModule.add(PanelSetupXPer.getSetupModule(panel,PANEL_SETUP_NATION_MAP,tree_main));
        }
        if(theHO.theGActionAuthV.isReadTreeRpMapOccupation())
        {
            PanelMapLookup panel = new PanelMapLookup();
            panel.setTitle(PANEL_SETUP_EDUCATION_MAP);
            panel.setControl(new MapControl(Report18FileData.MAP_EDUCATION,theUS,theHC.theConnectionInf)
                    ,theUS,theHO);
            vSetupModule.add(PanelSetupXPer.getSetupModule(panel,PANEL_SETUP_EDUCATION_MAP,tree_main));
        }
