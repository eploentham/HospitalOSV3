 ...
 * @author henbe
 */
public class PanelMapDrug extends javax.swing.JPanel {
    ...
    public void setControl(MapControl mapCon,UpdateStatus us,HosObject ho,LookupControl lc){
        ...
        MapControl mc2 = new MapControl(Report18FileData.LOOK_COMPANY,theUS,lc.theConnectionInf);
...
//         jTableMap.setRowSorter(sorter);
    ...
    private void dbclick() {
        ...
        {
            theMC.mapDataDrugV(getMapV(),getLookup());
    ...
    /**
     * henbe comment 030310 kong ให้ตรวจสอบจุดอื่นๆ ด้วยที่มีการเรียกใช้ array แบบนี้จะได้ป้องกันไว้ก่อนไม่ให้เกิดปัญหาในภายหลัง
     * index[0]!=null
     * @return
     */
...
//         jTableLookup.setRowSorter(sorter);
    ...
    private void initComponents() {
        ...
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        jPanel1.add(jButtonImportMap, gridBagConstraints);

        jButton1.setText("ปรับปรุงทะเบียนยา 24 หลัก");
    ...
    private void jTextFieldLookup1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldLookup1ActionPerformed
        ...
        setLookupV(theMC.listLookup2(str));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int status = jfc.showOpenDialog(this.theUS.getJFrame());
        if (status == JFileChooser.APPROVE_OPTION) {
            File selectedFile = jfc.getSelectedFile();
            this.theMC.importMapDrug(selectedFile);
        }
