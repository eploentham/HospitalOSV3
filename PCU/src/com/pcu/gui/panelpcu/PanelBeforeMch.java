...
//        initBalloon();
    ...
    private void initComponents() {
        ...
        jPanelPregnantNumDetail.add(jButton1, gridBagConstraints);
        ...
        dateComboBoxCheck1.setBackground(new java.awt.Color(204, 255, 255));
        ...
        timeTextFieldCheck1.setBackground(new java.awt.Color(204, 255, 255));
...
calPregnant();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            theUS.setStatus("กรุณาเลือกรายการตั้งครรภ์",UpdateStatus.WARNING);
            return;
        }
        this.getPregnacy();
        this.theHosDialog.showPanelEditLMP(theHosManage,thePregnancy);
        this.setPregnancy(thePregnancy);
...
//            tm.setValueAt(GutilPCU.changDateToString(pregnancyTemp.pregnancy_menses_expire_date, false), i, 1);
            tm.setValueAt(GutilPCU.changDateToString(pregnancyTemp.modify_date_time, false), i, 1);
        }
