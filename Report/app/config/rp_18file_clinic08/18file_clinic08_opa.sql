...
,q_opa.DATE_SERV
,q_opa.CHRGITEM
,sum(q_opa.AMOUNT) as AMOUNT
,(q_opa.SERVICE_ID || q_opa.CHRGITEM) as ID
,q_opa.NOTEDATE
,q_opa.ACTIVE
,q_opa.SERVICE_ID
FROM 
...
GROUP BY
    ...
    ,t_billing_invoice_billing_subgroup.billing_invoice_billing_subgroup_active,SERVICE_ID) q_opa
GROUP BY 
    q_opa.PCUCODE
    ,q_opa.CID
    ,q_opa.SEQ
