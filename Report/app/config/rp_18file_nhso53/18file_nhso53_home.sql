...
, CASE  
		WHEN length(t_health_sub_home.sub_home_record_date_time)>18
 	         then (to_number(substring(t_health_sub_home.sub_home_record_date_time,1,4),'9999') - 543)      
                        || substring(t_health_sub_home.sub_home_record_date_time,6,2)      
                        || substring(t_health_sub_home.sub_home_record_date_time,9,2) 
                        || substring(t_health_sub_home.sub_home_record_date_time,12,2) 
                        || substring(t_health_sub_home.sub_home_record_date_time,15,2) 
                        || substring(t_health_sub_home.sub_home_record_date_time,18,2)  
