...
FROM  t_health_nutrition 	  
    ...
    LEFT JOIN r_nutrition_map ON t_health_nutrition.f_health_nutrition_level_id = r_nutrition_map.f_visit_nutrition_level_id
    LEFT JOIN r_nutrition_type  ON r_nutrition_type.r_nutrition_type_id = r_nutrition_map.r_nutrition_type_id
    ,b_site
