...
FROM  t_health_pp_care as SUB1
        LEFT JOIN t_health_pp ON (t_health_pp.t_health_family_id = SUB1.t_health_family_id  and t_health_pp.pp_active  = '1')
        LEFT JOIN t_health_family ON t_health_pp.t_health_family_id = t_health_family.t_health_family_id 
