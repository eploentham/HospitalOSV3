 ...
 */
public class Config {
    static final String Config = "com/reportcenter/property/Config";
    //public static final String MODULE_PATH_REP = "../bin/ext_module_rep";  
    public static final String MODULE_PATH_REP = "config/ext_module_rp";
