 ...
 */
public class ChtNh extends Cht implements Rp12OI{
    ...
    public Object[] getDBFValue() {
        ...
        rowData[3] = Double.valueOf(p.total);
    ...
    public PreparedStatement getPreparedStatement(Connection con, String startDate, String endDate, int mode) throws Exception {
        String sql = IOStream.readInputDefault("config/rp_12file50/12file50_cht.sql");
