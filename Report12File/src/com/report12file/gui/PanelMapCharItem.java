...
/**
 * henbe comment 030310 kong ทำไมไม่ extend จาก ADPCode
 * แล้วเวลาเรียกก็ใช้ control คนละตัวกันก็ได้หน้าจอก็เหมือนกัน เวลาแก้จะได้ไม่ต้องแก้ทั้งคู่
 *
 * @author henbe
 */
public class PanelMapCharItem extends javax.swing.JPanel {
